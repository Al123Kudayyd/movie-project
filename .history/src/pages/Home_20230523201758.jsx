                    ...
                    <div className="main">
                        ...
                        <div className="main-container">
                            <div className="main-wrapper">
                                ...
                                {
                                 loading ? <FontAwesomeIcon icon='spinner' className='search-btn1' /> : <div onClick={() => navigate(`/${name}`)}><FontAwesomeIcon onClick={() => onLoad()} className='search-btn' icon='magnifying-glass' /></div>
                                } 
                            </div>
