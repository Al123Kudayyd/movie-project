                    ...
                    <div className="main">
                        ...
                        <div className="main-container">
                            <div className="main-wrapper">
                                ...
                                {
                                    loading ? (<FontAwesomeIcon onClick={() => navigate(`/${name}`)} icon='magnifying-glass' className='search-btn' />)
                                }
                                <FontAwesomeIcon onClick={() => navigate(`/${name}`)} icon='magnifying-glass' className='search-btn' />
                            </div>
