                    ...
                    <div className="main">
                        ...
                        <div className="main-container">
                            <div className="main-wrapper">
                                ...
                                {
                                 loading ? <div className='search-btn1'><FontAwesomeIcon icon='spinner-third' className='spinner'  /></div> : <FontAwesomeIcon onClick={() => onLoad()} className='search-btn' icon='magnifying-glass' />
                                } 
                            </div>
