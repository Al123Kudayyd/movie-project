...
export default function Cars() {
  ...
  async function getCars() {
    const { data } = await axios.get(`https://private-anon-916d788b16-carsapi1.apiary-mock.com/manufacturers/${name}`)
    setCars(data)
    console.log(data)
            ...
            <div className="row">
                <div className="nav-section">
                    ...
                    <div className="car-selector">
                        <input className='car-input' value={searchName}  type="text" placeholder='Search by Model, Make or Keyword ' />
                        <FontAwesomeIcon className='car-search-btn' onClick={() => search} icon='magnifying-glass' />
                    </div>
                </div>
            </div>
        </section>
